...
<script>
  export default {
    ...
    computed: {
      shouldShow: function () {
        return this.isSafari() || (this.isMobileOrTablet() && !this.isFirefox());
      }
    },
    methods: {
      // Refs: https://stackoverflow.com/a/11381730
      ...
      // Refs: https://stackoverflow.com/a/9851769
      isFirefox: function () {
